...
- 328661a: Add the v2 internal model, enable YAML merge keys, and accept `state:`/`parameters:`.
...
- 141d3f1: Widen the `@maplibre-yaml/core` peer range to span the whole 0.x line
  (`>=0.3.0 <1.0.0`).
