...
export const configDemoYAML = `type: map
id: config-demo
config:
...
export const simpleLayerYAML = `type: map
id: simple-layer
config:
  center: [-74.006, 40.7128]
  zoom: 10
...
export const controlsDemoYAML = `type: map
id: controls-demo
config:
  center: [-98, 39]
  zoom: 3
...
export const completeExampleYAML = `type: map
id: complete-example
config:
  center: [-98, 39]
  zoom: 4
