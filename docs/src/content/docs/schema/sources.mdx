...
For multi-page applications, sources can also be defined at the root level and referenced across pages using `$ref`:
...
All three patterns (block-level, root-level, inline) can be mixed freely within a configuration.
